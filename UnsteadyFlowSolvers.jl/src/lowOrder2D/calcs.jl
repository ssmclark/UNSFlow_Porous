...
function update_kinem(surf::Union{TwoDSurf,TwoDSurfPorous}, t)
    ...
    elseif (typeof(surf.kindef.alpha) == FileDef)
        surf.kinem.alpha = surf.kindef.alpha(t)
        surf.kinem.alphadot = ForwardDiff.derivative(surf.kindef.alpha,t)*surf.uref/surf.c
    elseif (typeof(surf.kindef.alpha) == AlphaDragonDef)
        surf.kinem.alpha = surf.kindef.alpha(t)
        surf.kinem.alphadot = ForwardDiff.derivative(surf.kindef.alpha,t)*surf.uref/surf.c
    elseif (typeof(surf.kindef.alpha) == DragonDef)
        surf.kinem.alpha = surf.kindef.alpha(t)
        alphadottemp=DragonDefVel(surf.kindef.alpha.Upstroke,surf.kindef.alpha.Dwstroke,surf.kindef.alpha.k,surf.kindef.alpha.deltaT)
        surf.kinem.alphadot = alphadottemp(t)
    ...
    elseif (typeof(surf.kindef.h) == FileDef)
        ...
        surf.kinem.hdot = ForwardDiff.derivative(surf.kindef.h,t)*surf.uref
    elseif (typeof(surf.kindef.h) == hDragonDef)
        surf.kinem.h = surf.kindef.h(t)
        surf.kinem.hdot = ForwardDiff.derivative(surf.kindef.h,t)*surf.uref
    elseif (typeof(surf.kindef.h) == positionDragonDef)
        surf.kinem.h = surf.kindef.h(t)
        surf.kinem.hdot = ForwardDiff.derivative(surf.kindef.h,t)*surf.uref
    ...
    elseif (typeof(surf.kindef.u) == LinearDef)
        surf.kinem.u = surf.kindef.u(t)*surf.uref
        surf.kinem.udot = ForwardDiff.derivative(surf.kindef.u,t)*surf.uref*surf.uref/surf.c
    elseif (typeof(surf.kindef.u) == UDragonDef)
        surf.kinem.u = surf.kindef.u(t)*surf.uref
        surf.kinem.udot = ForwardDiff.derivative(surf.kindef.u,t)*surf.uref*surf.uref/surf.c
...
function update_kinem2DOF(surf::Union{TwoDSurf,TwoDSurfPorous}, strpar :: TwoDOFPar, kinem :: KinemPar2DOF, dt, cl, cm)
    ...
    #inverse of the above matrices? some sort of transformation
    kinem.hddot_pr = (1/(m11*m22-m21*m12))*(m22*R1-m12*R2)
    kinem.alphaddot_pr = (1/(m11*m22-m21*m12))*(-m21*R1+m11*R2)

    #Kinematics are updated according to the 2DOF response (no idea where the numbers come from)
...
function update_kinem2DOFPorous(surf::TwoDSurfPorous, strpar :: TwoDOFPar, kinem :: KinemPar2DOF, dt, cl, cm)
    #Update previous terms
    kinem.alpha_pr = kinem.alpha
    kinem.h_pr = kinem.h
#three previous alphadot terms updated
...
#three previous hdot terms updated
    ...
    kinem.hdot_pr2 = kinem.hdot_pr
    kinem.hdot_pr = kinem.hdot
#same again for double derivatives of AoA and plunge
    kinem.alphaddot_pr3 = kinem.alphaddot_pr2
    kinem.alphaddot_pr2 = kinem.alphaddot_pr
    ...
    R2 = 8*strpar.kappa*surf.uref*surf.uref*cm/(pi*surf.c*surf.c) - strpar.w_alpha*strpar.w_alpha*strpar.r_alpha*strpar.r_alpha*(strpar.cubic_alpha_1*kinem.alpha + strpar.cubic_alpha_3*kinem.alpha^3)
    #resultant from matrix goes in here. Not sure 
    kinem.hddot_pr = (1/(m11*m22-m21*m12))*(m22*R1-m12*R2)
    kinem.alphaddot_pr = (1/(m11*m22-m21*m12))*(-m21*R1+m11*R2)
