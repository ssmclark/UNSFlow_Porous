...
function ldvmLin(surf::TwoDSurf, curfield::TwoDFlowField, nsteps::Int64 = 500, dtstar::Float64 = 0.015, startflag = 0, writeflag = 0, writeInterval = 1000., delvort = delNone(); maxwrite = 50, nround=6)
    ...
    for istep = 1:nsteps
        ...
        #Calculate downwash
        #This is getting replaced with update_downwash_porous!!!!!
...
function ldvm2DOF(surf::TwoDSurf, curfield::TwoDFlowField, kinem::KinemPar2DOF, strpar::TwoDOFPar ,nsteps::Int64 = 500, dtstar::Float64 = 0.015, startflag = 0, writeflag = 0, writeInterval = 1000., delvort = delNone(); maxwrite = 50, nround=6)
...
function ldvm2DOFPorous(surf::TwoDSurfPorous, curfield::TwoDFlowField, strpar::TwoDOFPar, kinem::KinemPar2DOF, nsteps::Int64 = 500, dtstar::Float64 = 0.015, startflag = 0, writeflag = 0, writeInterval = 1000., delvort = delNone(); maxwrite = 50, nround=6)
    ...
    for istep = 1:nsteps
        ...
        update_kinem2DOFPorous(surf, strpar, kinem, dt, cl, cm)
        ...
        #Solve for TEV strength to satisfy Kelvin condition
        kelv = KelvinConditionPorous(surf,curfield)
        soln = nlsolve(not_in_place(kelv), [-0.01])
        curfield.tev[length(curfield.tev)].s = soln.zero[1]
        ...
        # for writing in resultsSummary
        mat = hcat(mat,[t, surf.kinem.alpha, surf.kinem.h, surf.kinem.u, surf.a0[1], cl, cd, cm, p_com])
